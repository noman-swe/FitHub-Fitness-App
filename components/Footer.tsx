            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div className="col-span-1 md:col-span-2">
                        ...
                        <p className="mb-6 leading-relaxed max-w-md text-muted-foreground">
                        ...
                        <div className="flex space-x-4">
                            <Link
                                href="/"
                                className="w-10 h-10 bg-secondary/40 rounded-full flex items-center justify-center hover:bg-primary transition-colors duration-300 text-muted-foreground "
                            >
                    ...
                    <div>
                        <h4 className="text-lg font-bold font-heading mb-4 text-primary">Quick Links</h4>
                    ...
                    {/* Contact Info */}
                    <div>
                        <h4 className="text-primary text-lg font-bold font-heading mb-4">
                            Contact Info
                        </h4>
