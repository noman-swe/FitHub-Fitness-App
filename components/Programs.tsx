            ...
            <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 '>
                <div className='text-center mb-16'>
                    ...
                    <motion.p
                        ...
                        className="text-xl text-muted-foreground max-w-2xl mx-auto">Choose from our comprehensive fitness programs designed to meet your specific goals and fitness level.</motion.p>
                </div>
                {/* Program Cards */}
                    ...
                    {programs.map((program, index) => (
                        <motion.div
                            ...
                            <Card className='p-0 transition-shadow duration-300 hover:shadow-2xl'>
                                <div className="relative overflow-hidden rounded-t-lg w-full h-60 md:h-56 lg:h-48  ">
                                ...
                                <CardContent className='p-6 pt-0'>
                                    <motion.h3
                                        ...
                                        whileInView={{ opacity: 1, y: 0 }}
                                        viewport={{ once: true }}
                                        transition={{ duration: 0.5, ease: "easeOut", delay: index * 0.2 }} className='text-xl font-bold font-heading mb-3 text-foreground group-hover:text-primary transition-colors'>{program?.title}</motion.h3>
                                    <motion.p
